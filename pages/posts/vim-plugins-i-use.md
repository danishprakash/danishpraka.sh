...
Note: I'm using [vim-zen](https://github.com/danishprakash/vim-zen) as my plugin manager, It's a lightweight barebones vim plugin manager with multithreading (python). You can learn more about it [here](https://github.com/danishprakash/vim-zen).

1. [junegunn/goyo.vim](https://github.com/junegunn/goyo.vim)<br>
...
2. [airblade/vim-gitgutter](https://github.com/airblade/vim-gitgutter)<br>
...
3. [tpope/vim-surround](https://github.com/tpope/vim-surround)<br>
...
4. [townk/vim-autoclose](https://github.com/townk/vim-autoclose)<br>
...
5. [tpope/vim-commentary](https://github.com/tpope/vim-commentary)<br>
...
6. [morhetz/gruvbox](https://github.com/morhetz/gruvbox)<br>
...
7. [junegunn/fzf](https://github.com/junegunn/fzf)<br>
...
8. [scrooloose/nerdtree](https://github.com/scrooloose/nerdtree)<br>
...
9. [ervandew/supertab](https://github.com/ervandew/supertab)<br>
...
10. [danishprakash/vimport](https://github.com/danishprakash/vimport)<br>

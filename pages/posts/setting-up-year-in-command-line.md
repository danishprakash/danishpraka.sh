...
If you're feeling particularly ambitious, you could dive deeper into the data to figure out potential commands that you run a lot, and create aliases based on usage pattersn so shave off a few milliseconds off your workflow.
